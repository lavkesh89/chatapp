      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          <div className="h-full w-32 md:w-48 md:h-48 relative flex items-center justify-center" onMouseEnter={()=>setHovered(true)} onMouseLeave={()=>setHovered(false)}>
            ...
            {hovered && <div className="absolute inset-0 flex items-centers justify-center bg-black/50 ring-fuchsia-50 rounded-full" onClick={image ? handleDeleteImage : handleFileInputClick}>{image ? ( <FaTrash className="text-white text-3x cursor-pointer"/>) : (<FaPlus className="text-white text-2xl cursor-pointer"/>)}</div>}
